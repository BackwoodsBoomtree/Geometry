...
function derive_spectrum()
    ...
    plot_line_regress(_ax3, _sif740, convert(Array, _data.sif740); interval=true);
    ...
    plot_line_regress(_ax4, _sif757, convert(Array, _data.sif757); interval=true);
    ...
    plot_line_regress(_ax5, _sif771, convert(Array, _data.sif771); interval=true);
