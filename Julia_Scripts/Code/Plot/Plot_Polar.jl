...
function plot_polar(sza, vza_max, plot_type, clump)
    ...
    elseif plot_type == "757_clump"
        ...
        subplot(3,3,1, polar = true)
        grid(false)
        plot_sif_757 = contourf(deg2rad.(collect((0:360))), collect(0:1:vza_max), sif_757[1:(vza_max + 1), :], levels = collect(1.2:0.2:2.6), cmap = :viridis)
        xticks(fontsize = 11)
        yticks(fontsize = 11)
        ...
        subplot(3,3,2, polar = true)
        grid(false)
        plot_nirv = contourf(deg2rad.(collect((0:360))), collect(0:1:vza_max), nirv[1:(vza_max + 1), :], levels = collect(0.20:0.5:0.45), cmap = :viridis)
        xticks(fontsize = 11)
        yticks(fontsize = 11)
        ...
        subplot(3,3,3, polar = true)
        grid(false)
        plot_sif_757_rel = contourf(deg2rad.(collect((0:360))), collect(0:1:vza_max), sif_757_rel[1:(vza_max + 1), :], levels = collect(0.0172:0.5:0.0202), cmap = :viridis)
        xticks(fontsize = 11)
        yticks(fontsize = 11)
        ...
        subplot(3,3,4, polar = true)
        grid(false)
        plot_sif_757_c = contourf(deg2rad.(collect((0:360))), collect(0:1:vza_max), sif_757_c[1:(vza_max + 1), :], levels = collect(1.2:0.2:2.6), cmap = :viridis)
        xticks(fontsize = 11)
        yticks(fontsize = 11)
        ...
        subplot(3,3,5, polar = true)
        grid(false)
        plot_nirv_c = contourf(deg2rad.(collect((0:360))), collect(0:1:vza_max), nirv_c[1:(vza_max + 1), :], levels = collect(0.20:0.5:0.45), cmap = :viridis)
        xticks(fontsize = 11)
        yticks(fontsize = 11)
        ...
        subplot(3,3,6, polar = true)
        grid(false)
        plot_sif_757_rel_c = contourf(deg2rad.(collect((0:360))), collect(0:1:vza_max), sif_757_rel_c[1:(vza_max + 1), :], levels = collect(0.0172:0.5:0.0202), cmap = :viridis)
        xticks(fontsize = 11)
        yticks(fontsize = 11)
