...
# Variables can come from both GOSAT and OCO files, although variable may not appear in one or the other.
# Function skips variable if it does not appear.
...
# Run function for each satellite seperately
