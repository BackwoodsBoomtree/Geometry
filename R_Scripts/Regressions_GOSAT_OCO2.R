...
MCResult.plot(reg_SIF_740nm_unfiltered, equal.axis = TRUE, x.lab = "GOSAT P SIF 740nm", y.lab = "Mean OCO-2 SIF 740nm", main = "Unfiltered (QC = Best; Cloud Free)",
              sub = "", tck = 0.03, mgp = c(3, 0.3, 0), identity.lwd = 2)
...
# pdf("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/Regressions_GOSAT_P_OCO2_SIF740.pdf", width=8, height=8, compress=FALSE)
