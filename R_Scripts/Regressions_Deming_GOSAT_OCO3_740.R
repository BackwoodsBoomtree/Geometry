...
veg_matched_sounding_means <- read.csv("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/OCO3/veg_matched_sounding_means_oco3.csv")
time_veg_matched_sounding_means <- read.csv("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/OCO3/time_veg_matched_sounding_means_oco3.csv")
vza_time_veg_matched_sounding_means <- read.csv("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/OCO3/vza_time_veg_matched_sounding_means_oco3.csv")
n_vza_time_veg_matched_sounding_means <- read.csv("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/OCO3/n_vza_time_veg_matched_sounding_means_oco3.csv")
...
var_err_OCO3_SIF_740nm_unfiltered          <- var(unfiltered_matched_sounding_means$Mean_OCO_SIF_Uncertainty_740nm)
var_err_OCO3_SIF_740nm_veg                 <- var(veg_matched_sounding_means$Mean_OCO_SIF_Uncertainty_740nm)
var_err_OCO3_SIF_740nm_time_veg            <- var(time_veg_matched_sounding_means$Mean_OCO_SIF_Uncertainty_740nm)
var_err_OCO3_SIF_740nm_vza_time_veg        <- var(vza_time_veg_matched_sounding_means$Mean_OCO_SIF_Uncertainty_740nm)
var_err_OCO3_SIF_740nm_n_vza_time_veg      <- var(n_vza_time_veg_matched_sounding_means$Mean_OCO_SIF_Uncertainty_740nm)
var_err_OCO3_SIF_740nm_temp_n_vza_time_veg <- var(temp_n_vza_time_veg_matched_sounding_means$Mean_OCO_SIF_Uncertainty_740nm)

var_err_ratio_SIF_740nm_unfiltered          <- var_err_OCO3_SIF_740nm_unfiltered / var_err_GOSAT_SIF_740nm_unfiltered
var_err_ratio_SIF_740nm_veg                 <- var_err_OCO3_SIF_740nm_veg / var_err_GOSAT_SIF_740nm_veg
var_err_ratio_SIF_740nm_time_veg            <- var_err_OCO3_SIF_740nm_time_veg / var_err_GOSAT_SIF_740nm_time_veg 
var_err_ratio_SIF_740nm_vza_time_veg        <- var_err_OCO3_SIF_740nm_vza_time_veg / var_err_GOSAT_SIF_740nm_vza_time_veg
var_err_ratio_SIF_740nm_n_vza_time_veg      <- var_err_OCO3_SIF_740nm_n_vza_time_veg / var_err_GOSAT_SIF_740nm_n_vza_time_veg
var_err_ratio_SIF_740nm_temp_n_vza_time_veg <- var_err_OCO3_SIF_740nm_temp_n_vza_time_veg / var_err_GOSAT_SIF_740nm_temp_n_vza_time_veg
...
reg_SIF_740nm_unfiltered          <- mcreg(mean_GOSAT_SIF_740nm_unfiltered, unfiltered_matched_sounding_means$Mean_OCO_SIF_740nm, method.reg = "Deming", error.ratio = var_err_ratio_SIF_740nm_unfiltered,
                                           mref.name = "GOSAT", mtest.name = "OCO-3")
...
pdf("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/Regressions_Deming_GOSAT_P_OCO3_SIF740.pdf", width=8.5, height=6, compress=FALSE)
...
pdf("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/Regressions_Deming_GOSAT_S_OCO3_SIF740.pdf", width=8.5, height=6, compress=FALSE)
...
pdf("C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/Regressions_Deming_GOSAT_PS_OCO3_SIF740.pdf", width=8.5, height=6, compress=FALSE)
...
polydf_oco3 <- build_polyDF(veg_matched_oco3_sounding_list)
shapefile(polydf_oco3, "C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/Veg_Matched_OCO3.shp", overwrite = TRUE)
