...
collapse_soundings <- function(matched_gosat_sounding_list, matched_oco2_sounding_list) {
  ...
  # Subset OCO2 soundings by GOSAT sounding and calculate mean SIF and SE of the mean, and mean Uncertainty then add it to GOSAT sounding list
...
write.csv(unfiltered_matched_sounding_means,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/unfiltered_matched_sounding_means.csv", row.names = FALSE)

write.csv(matched_gosat_sounding_list,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/matched_gosat_sounding_list.csv", row.names = FALSE)
write.csv(matched_oco2_sounding_list,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/matched_oco2_sounding_list.csv", row.names = FALSE)

write.csv(veg_matched_gosat_sounding_list,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/veg_matched_gosat_sounding_list.csv", row.names = FALSE)
write.csv(veg_matched_oco2_sounding_list,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/veg_matched_oco2_sounding_list.csv", row.names = FALSE)

write.csv(veg_matched_sounding_means,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/veg_matched_sounding_means.csv", row.names = FALSE)
write.csv(time_veg_matched_sounding_means,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/time_veg_matched_sounding_means.csv", row.names = FALSE)
write.csv(vza_time_veg_matched_sounding_means,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/vza_time_veg_matched_sounding_means.csv", row.names = FALSE)
write.csv(n_vza_time_veg_matched_sounding_means,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/n_vza_time_veg_matched_sounding_means.csv", row.names = FALSE)
write.csv(temp_n_vza_time_veg_matched_sounding_means,"C:/Russell/Projects/Geometry/R_Scripts/Figures/Match_GOSAT_OCO/CSV/temp_n_vza_time_veg_matched_sounding_means.csv", row.names = FALSE)
